...
// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/extensions/cornerstone/src/components/OHIFCornerstoneViewportOverlay.css
var components_OHIFCornerstoneViewportOverlay = __webpack_require__(1051);

// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/node_modules/moment/moment.js
var moment = __webpack_require__(6);
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);

// CONCATENATED MODULE: /home/david/dev/evs/viewer/ohif/extensions/cornerstone/src/utils/formatStudy.js
...
// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/ui/src/elements/Icon/index.js + 2 modules
var Icon = __webpack_require__(19);

// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/ui/src/components/tooltip/index.js + 1 modules
var tooltip = __webpack_require__(83);

// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/ui/src/components/overlayTrigger/index.js + 4 modules
var overlayTrigger = __webpack_require__(76);

// CONCATENATED MODULE: /home/david/dev/evs/viewer/ohif/extensions/cornerstone/src/components/OHIFCornerstoneViewportOverlay.js
...
var index_umd = __webpack_require__(1052);
...
var lodash_throttle = __webpack_require__(196);
...
var _OHIF$measurements$Me = src["b" /* default */].measurements.MeasurementHandlers,
...
var StackManager = src["b" /* default */].utils.StackManager;
...
function (_Component) {
  ...
  function OHIFCornerstoneViewport() {
    ...
    OHIFCornerstoneViewport_defineProperty(OHIFCornerstoneViewport_assertThisInitialized(_this), "getViewportData", function (studies, StudyInstanceUID, displaySetInstanceUID, SOPInstanceUID, frameIndex) {
      var viewportData;
      var stack = OHIFCornerstoneViewport.getCornerstoneStack(studies, StudyInstanceUID, displaySetInstanceUID, SOPInstanceUID, frameIndex);
      viewportData = {
  ...
  OHIFCornerstoneViewport_createClass(OHIFCornerstoneViewport, [{
    ...
    value: function setStateFromProps() {
      ...
      var viewportData = this.getViewportData(studies, StudyInstanceUID, displaySetInstanceUID, SOPInstanceUID, frameIndex);
      this.setState({
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (displaySet.displaySetInstanceUID !== prevDisplaySet.displaySetInstanceUID || displaySet.SOPInstanceUID !== prevDisplaySet.SOPInstanceUID || displaySet.frameIndex !== prevDisplaySet.frameIndex) {//this.setStateFromProps();
      }
    }
    /*
    ...
    */
    ...
    value: function render() {
      ...
      var _this$state$viewportD = this.state.viewportData.stack,
          ...
          currentImageIdIndex = _this$state$viewportD.currentImageIdIndex;
      console.log('viewport index: ' + viewportIndex.toString());
      console.log(imageIds); // TODO: Does it make more sense to use Context?

      if (this.props.children && this.props.children.length) {
        childrenWithProps = this.props.children.map(function (child, index) {
          return child && react_default.a.cloneElement(child, {
            viewportIndex: _this2.props.viewportIndex,
            key: index
          });
        });
      }

      var newImageHandler = function newImageHandler(_ref) {
        var currentImageIdIndex = _ref.currentImageIdIndex,
            sopInstanceUid = _ref.sopInstanceUid;
        var displaySet = _this2.props.viewportData.displaySet;
        var StudyInstanceUID = displaySet.StudyInstanceUID;

        if (currentImageIdIndex > 0) {
          _this2.props.onNewImage({
            StudyInstanceUID: StudyInstanceUID,
      ...
      if (imageIds.length === 0) return null;else return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(src_ConnectedCornerstoneViewport, _extends({
