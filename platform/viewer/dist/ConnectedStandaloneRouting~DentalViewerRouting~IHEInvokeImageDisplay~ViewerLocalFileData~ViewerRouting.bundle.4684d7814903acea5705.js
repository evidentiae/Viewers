...
function (_Component) {
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function createNewImageInstance(index, url) {
      var image = document.createElement("img");
      image.src = url;
      console.log("image");
      console.log(image.width);
      console.log(image.height);
      var canvas = document.createElement("canvas"); //canvas.width = image.width;
    ...
    value: function uploadImage() {
      ...
      input.onchange = function (e) {
        ...
        reader.onload = function (ev) {
          ...
          _this2.createNewImageInstance(index, url);
