...
function (_Component) {
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function getClient(url) {
      ...
      var errorInterceptor = errorHandler.getHTTPErrorHandler(); // TODO: a bit weird we are creating a new dicomweb client instance for every upload
    ...
    value: function createNewStudy(layout) {
      ...
      var content = new Uint8Array(JSON.stringify(dataset)).buffer;
      console.log(content);
