  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function createNewImageInstance(index, imageData) {
      ...
      */
      ...
      console.log(jpegImageData.data.buffer); // We need to manually pad the buffer to avoid complaints from Google even
...
var ConnectedViewer_OHIF$redux$actions = src["b" /* default */].redux.actions,
    ...
    setViewportLayout = ConnectedViewer_OHIF$redux$actions.setViewportLayout;
