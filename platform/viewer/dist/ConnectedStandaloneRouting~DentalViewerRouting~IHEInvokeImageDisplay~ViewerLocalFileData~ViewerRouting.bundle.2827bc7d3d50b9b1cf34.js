...
var LayoutPickerDialog_LayoutPickerDialog = __webpack_require__(1052);
...
var _dcmjs$data = dcmjs_es["a" /* default */].data,
    ...
    DicomDict = _dcmjs$data.DicomDict; // Contexts
...
function (_Component) {
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function createNewStudy(layout) {
      console.log("createNewStudy"); // dialog should return some representation of layout, like frames, positions, etc
    ...
    value: function uploadImage() {
      ...
      input.onchange = function (e) {
        ...
        image.src = objectURL; //window.URL.revokeObjectURL(objectURL);
      ...
      image.onload = function (ev) {
        ...
        _this2.createNewImageInstance(index, imageData);
      };
      ...
      input.click(); //document.body.removeChild(input);
    }
  }, {
    key: "createNewImageInstance",
    value: function createNewImageInstance(index, data) {
    ...
    value: function render() {
      ...
      panelExtensions.forEach(function (panelExt) {
        panelExt.module.components.forEach(function (comp) {
          if (comp.id === _this3.state.selectedRightSidePanel) {
            VisiblePanelRight = comp.component;
          } else if (comp.id === _this3.state.selectedLeftSidePanel) {
...
var ConnectedViewer_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    onNewStudy: function onNewStudy(layout) {
