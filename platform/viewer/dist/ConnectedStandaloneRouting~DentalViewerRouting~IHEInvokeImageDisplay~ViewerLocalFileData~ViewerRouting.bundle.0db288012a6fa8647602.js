...
var ViewportGrid_ViewportGrid = function ViewportGrid(props) {
  ...
  if (viewportData.displaySet) {
    ...
    if (numFrames == 1) {
      numRows = (_readOnlyError("numRows"), 1);
      numColumns = (_readOnlyError("numColumns"), 1);
    } else if (numFrames == 2) {
      numRows = (_readOnlyError("numRows"), 1);
      numColumns = (_readOnlyError("numColumns"), 2);
    } else if (numFrames == 3) {
      numRows = (_readOnlyError("numRows"), 1);
      numColumns = (_readOnlyError("numColumns"), 3);
    } else if (numFrames == 4) {
      numRows = (_readOnlyError("numRows"), 2);
      numColumns = (_readOnlyError("numColumns"), 2);
    } else if (numFrames == 5) {
      numRows = (_readOnlyError("numRows"), 2);
      numColumns = (_readOnlyError("numColumns"), 3);
      ...
      numRows = (_readOnlyError("numRows"), 2);
      numColumns = (_readOnlyError("numColumns"), 4);
    } else if (numFrames == 8) {
      numRows = (_readOnlyError("numRows"), 2);
      numColumns = (_readOnlyError("numColumns"), 4);
    } else if (numFrames == 9) {
      numRows = (_readOnlyError("numRows"), 3);
      numColumns = (_readOnlyError("numColumns"), 3);
    } else if (numFrames == 10) {
      numRows = (_readOnlyError("numRows"), 3);
      numColumns = (_readOnlyError("numColumns"), 4);
