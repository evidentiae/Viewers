...
var MODULE_TYPES = __webpack_require__(607);
...
var connectedComponents_ToolbarRow = __webpack_require__(1042);
...
function (_Component) {
  ...
  function ToolbarRow(props) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "onMaximize", function () {
      _this2.props.handleMaximize();
    });
  ...
  _createClass(ToolbarRow, [{
    ...
    value: function render() {
      ...
      })), buttonComponents, react_default.a.createElement(connectedComponents_ConnectedLayoutButton, null), react_default.a.createElement(ui_src["C" /* ToolbarButton */], {
        label: 'Maximize',
        icon: "th",
        isActive: true,
...
var connectedComponents_ViewerMain = __webpack_require__(1043);

// EXTERNAL MODULE: ./components/DentalGrid/ViewportGrid.css
var DentalGrid_ViewportGrid = __webpack_require__(1044);
...
var DentalGrid_ViewportPane = __webpack_require__(1045);
...
var EmptyViewport = __webpack_require__(1046);
...
var ViewportGrid_ViewportGrid = function ViewportGrid(props) {
  ...
  */
  ...
  var getViewportPanes = function getViewportPanes() {
    var maximizedViewport = layout.viewports[activeViewportIndex];
    var viewports = maximized ? maximizedViewport : layout.viewports;
    return viewports.map(function (layout, viewportIndex) {
...
var values = __webpack_require__(1047);
...
var components_SidePanel = __webpack_require__(1049);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog = __webpack_require__(1050);
...
var connectedComponents_Viewer = __webpack_require__(1051);

// EXTERNAL MODULE: /home/david/dev/evs/viewers-clean/node_modules/stream-browserify/index.js
var stream_browserify = __webpack_require__(1052);
  ...
  return studies.map(function (study) {
    ...
    var thumbnails = study.series.map(function (series) {
      ...
      var _displaySet = displaySet,
          ...
          numImageFrames = _displaySet.numImageFrames,
