...
var connectedComponents_ToolbarRow = __webpack_require__(1043);
...
var lodash_clonedeep = __webpack_require__(28);
...
var ConnectedCineDialog = Object(es["b" /* connect */])(ConnectedCineDialog_mapStateToProps, mapDispatchToProps, ConnectedCineDialog_mergeProps)(ui_src["b" /* CineDialog */]);
...
var ConnectedStudyBrowser_OHIF$redux$actions = src["a" /* OHIF */].redux.actions,
    ...
    setViewportLayoutAndData = ConnectedStudyBrowser_OHIF$redux$actions.setViewportLayoutAndData; // TODO
...
var connectedComponents_ViewerMain = __webpack_require__(1044);

// EXTERNAL MODULE: ./components/DentalGrid/ViewportGrid.css
var DentalGrid_ViewportGrid = __webpack_require__(1045);
...
var DentalGrid_ViewportPane = __webpack_require__(1046);
...
var EmptyViewport = __webpack_require__(1047);
...
var ViewportGrid_ViewportGrid = function ViewportGrid(props) {
  ...
  */
  ...
  var effectiveNumRows = maximized ? 1 : numRows;
  var effectiveNumColumns = maximized ? 1 : numColumns;
  var rowSize = 100 / effectiveNumRows;
  var colSize = 100 / effectiveNumColumns; // http://grid.malven.co/
  ...
  */
  ...
  return react_default.a.createElement("div", {
    ...
    style: {
      display: 'grid',
      gridTemplateRows: "repeat(".concat(effectiveNumRows, ", ").concat(rowSize, "%)"),
      gridTemplateColumns: "repeat(".concat(effectiveNumColumns, ", ").concat(colSize, "%)"),
      height: '100%',
      width: '100%'
    }
  }, ViewportPanes);
...
var ConnectedViewportGrid = Object(es["b" /* connect */])(ConnectedViewportGrid_mapStateToProps, null)(components_DentalGrid_ViewportGrid);
...
var values = __webpack_require__(1048);
...
var components_SidePanel = __webpack_require__(1050);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog = __webpack_require__(1051);
...
var LayoutPickerDialog_LayoutPickerDialog =
/*#__PURE__*/
function (_Component) {
  ...
  function LayoutPickerDialog(props) {
    ...
    LayoutPickerDialog_defineProperty(LayoutPickerDialog_assertThisInitialized(_this), "handleChange", function (event) {
      _this.setState({});
    });
  ...
  LayoutPickerDialog_createClass(LayoutPickerDialog, [{
    ...
    value: function render() {
      return react_default.a.createElement(SimpleDialog["a" /* default */], {
        ...
        onConfirm: this.onConfirm //rootClass="editDescriptionDialog"

      }, react_default.a.createElement("h2", null, "Test"), "/*", react_default.a.createElement("input", {
...
LayoutPickerDialog_defineProperty(LayoutPickerDialog_LayoutPickerDialog, "propTypes", {
...
/* harmony default export */ var components_LayoutPickerDialog = (LayoutPickerDialog_LayoutPickerDialog);
...
var connectedComponents_Viewer = __webpack_require__(1052);

// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/node_modules/stream-browserify/index.js
var stream_browserify = __webpack_require__(1053);
...
var ConnectedViewer_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    onNewStudy: function onNewStudy() {
