    ...
    value: function createNewStudy(layout) {
      ...
      if (layout === 'Panoramic') {
        ...
        imageBoxes = [// left six boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [0 + m, 1 - hm - h, w - m / 2, 1 - hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm - h, w * 2 - m / 2, 1 - hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [0 + m, 1 - hm - h * 2, w - m / 2, 1 - hm - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm - h * 2, w * 2 - m / 2, 1 - hm - h * 3]
          }
        }, // middle top boxes
        {
          "00720302": {
        ...
        }, // middle bottom boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 2 + m, 1 - hm - h * 2, w * 3 - m / 2, 1 - hm - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 3 + m / 2, 1 - hm - h * 2, w * 4 - m / 2, 1 - hm - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 4 + m / 2, 1 - hm - h * 2, w * 5 - m / 2, 1 - hm - h * 3]
          }
        }, // right six boxes
        {
          "00720302": {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m, 1 - hm - h, w * 6 - m / 2, 1 - hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm - h, w * 7 - m / 2, 1 - hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m, 1 - hm - h * 2, w * 6 - m / 2, 1 - hm - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm - h * 2, w * 7 - m / 2, 1 - hm - h * 3]
          }
        }];
      }
