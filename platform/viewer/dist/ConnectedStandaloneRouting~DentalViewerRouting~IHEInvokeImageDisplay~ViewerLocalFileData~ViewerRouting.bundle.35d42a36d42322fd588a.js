...
var ConnectedViewer_OHIF$redux$actions = src["b" /* default */].redux.actions,
    ...
    ConnectedViewer_setViewportSpecificData = ConnectedViewer_OHIF$redux$actions.setViewportSpecificData;
...
var ConnectedViewer_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    afterUpload: function afterUpload(index, displaySet) {
      dispatch(ConnectedViewer_setViewportSpecificData(index, displaySet));
    }
  };
};
