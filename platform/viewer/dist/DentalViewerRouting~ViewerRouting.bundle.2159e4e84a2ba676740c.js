...
var usePrevious = __webpack_require__(1021);

// EXTERNAL MODULE: ./connectedComponents/ConnectedViewer.js + 18 modules
var ConnectedViewer = __webpack_require__(1028);
...
function ViewerRetrieveStudyData(_ref) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee2(studyMetadata) {
      var _studyMetadata$getDat, seriesLoader, loadNextSeries, concurrentRequestsAllowed, promises, remainingPromises;
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              remainingPromises = _context2.sent;
              setIsStudyLoaded(true);
              return _context2.abrupt("return", remainingPromises);
...
"use strict";
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79);
