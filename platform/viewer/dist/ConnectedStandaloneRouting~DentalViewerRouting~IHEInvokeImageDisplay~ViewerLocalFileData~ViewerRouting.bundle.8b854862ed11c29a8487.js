    ...
    value: function createNewStudy(layout) {
      ...
      if (layout === 'Panoramic') {
        ...
        imageBoxes = [// left six boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm, w * 2 - m / 2, 1 - hm - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [0 + m, 1 - hm - h, w - m / 2, 1 - hm - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm - h, w * 2 - m / 2, 1 - hm - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
        ...
        }, // middle top boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 2 + m, 1 - hm, w * 3 - m / 2, 1 - hm - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 3 + m / 2, 1 - hm, w * 4 - m / 2, 1 - hm - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 4 + m / 2, 1 - hm, w * 5 - m / 2, 1 - hm - h]
          }
        }, // middle bottom boxes
        {
          "00720302": {
        ...
        }, // right six boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m, 1 - hm, w * 6 - m / 2, 1 - hm - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm, w * 7 - m / 2, 1 - hm - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m, 1 - hm - h, w * 6 - m / 2, 1 - hm - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm - h, w * 7 - m / 2, 1 - hm - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
