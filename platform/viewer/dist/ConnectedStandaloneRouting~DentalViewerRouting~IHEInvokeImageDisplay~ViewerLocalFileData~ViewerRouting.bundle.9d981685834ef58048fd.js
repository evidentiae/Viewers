...
var jpeg_js = __webpack_require__(1043);
...
var connectedComponents_ToolbarRow = __webpack_require__(1048);
...
var connectedComponents_ViewerMain = __webpack_require__(1049);

// EXTERNAL MODULE: ./components/DentalGrid/ViewportGrid.css
var DentalGrid_ViewportGrid = __webpack_require__(1050);
...
var DentalGrid_ViewportPane = __webpack_require__(1051);
...
var EmptyViewport = __webpack_require__(1052);
...
var values = __webpack_require__(1053);
...
var components_SidePanel = __webpack_require__(1055);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog = __webpack_require__(1056);
...
var LayoutPickerDialog_LayoutPickerDialog = __webpack_require__(1057);
...
var connectedComponents_Viewer = __webpack_require__(1058);

// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/node_modules/stream-browserify/index.js
var stream_browserify = __webpack_require__(1059);
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function createNewImageInstance(index, imageData) {
      ...
      */
      ...
      dict.upsertTag("00280006", "US", [1]); // Planar Configuration
      ...
      */
      ...
      var jpegImageData = jpeg_js_default.a.encode(imageData, 90);
      console.log(jpegImageData.data.buffer);
      var buf = new ArrayBuffer(jpegImageData.data.buffer.byteLength + 1);
      new Uint8Array(buf).set(new Uint8Array(jpegImageData.data.buffer)); //dict.upsertTag("7FE00010", "OB", [rgb_buffer.buffer]); // Pixel Data
      ...
      console.log("storeInstances()"); // XXX: we need a spinner here
