...
function (_Component) {
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function createNewStudy(layout) {
      ...
      var dict = new DicomDict(metadata); //dict.upsertTag("00020010", "UI", ["1.2.840.10008.1.2"]); // Transfer Syntax UID
      ...
      console.log(url);
      var client = this.getClient(url); //var encoder = new TextEncoder();
