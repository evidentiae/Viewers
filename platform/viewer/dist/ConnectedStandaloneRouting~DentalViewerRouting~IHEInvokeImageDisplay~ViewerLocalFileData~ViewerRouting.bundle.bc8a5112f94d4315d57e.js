...
var ConnectedStudyBrowser_OHIF$redux$actions = src["a" /* default */].redux.actions,
...
var ConnectedStudyBrowser_mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    onThumbnailClick: function onThumbnailClick(displaySetInstanceUID) {
      ...
      var displaySet2 = lodash_clonedeep_default()(displaySet);
      displaySet2.SOPInstanceUID = "123"; //dispatch(setActiveViewportSpecificData(displaySet));
