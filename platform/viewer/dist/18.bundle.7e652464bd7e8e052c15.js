...
var src_DicomHtmlViewport = __webpack_require__(1084);
...
var DicomHtmlViewport_getContentSequence = function getContentSequence(data) {
  ...
  Object.keys(data).forEach(function (key) {
    ...
    if (key === '_meta') {
      var _HeaderDynamicLevel = "h3";
      root.push(react_default.a.createElement("hr", null));
      root.push(react_default.a.createElement(_HeaderDynamicLevel, {
        key: "Metadata"
...
var _setViewportActive = src["b" /* default */].redux.actions.setViewportActive;
...
var DicomLoaderService = src["b" /* default */].utils.DicomLoaderService;
