...
// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/ui/src/index.js + 105 modules
...
// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/core/src/index.js + 33 modules
...
var dist_es = __webpack_require__(36);

// EXTERNAL MODULE: ./connectedComponents/ToolbarRow.css
var connectedComponents_ToolbarRow = __webpack_require__(1058);
...
var lodash_clonedeep = __webpack_require__(31);
...
var setViewportSpecificData = core_src["b" /* default */].redux.actions.setViewportSpecificData; // Why do I need or care about any of this info?
...
var ConnectedCineDialog = Object(es["b" /* connect */])(ConnectedCineDialog_mapStateToProps, ConnectedCineDialog_mapDispatchToProps, ConnectedCineDialog_mergeProps)(src["b" /* CineDialog */]);
...
var ConnectedLayoutButton = Object(es["b" /* connect */])(ConnectedLayoutButton_mapStateToProps, ConnectedLayoutButton_mapDispatchToProps, ConnectedLayoutButton_mergeProps)(src["i" /* LayoutButton */]);
...
var AppContext = __webpack_require__(80);
...
function (_Component) {
  ...
  _createClass(ToolbarRow, [{
    ...
    value: function updateButtonGroups() {
      ...
      panelModules.forEach(function (panelExtension) {
        ...
        panelModule.menuOptions.forEach(function (menuOption) {
          ...
          try {
            isDisabled = typeof menuOption.isDisabled === 'function' && menuOption.isDisabled(_this3.props.studies, _this3.props.activeViewport);
          } catch (error) {
            isDisabled = true;
          }
    ...
    value: function render() {
      ...
      }, react_default.a.createElement(src["r" /* RoundedButtonGroup */], {
        options: this.buttonGroups.left,
        value: this.props.selectedLeftSidePanel || '',
        onValueChanged: onPressLeft
      })), react_default.a.createElement(src["D" /* ToolbarButton */], {
        label: "New study",
        icon: "th",
        isActive: true,
        onClick: this.props.handleNewStudy
      }), buttonComponents, this.props.showMaxMin && react_default.a.createElement(src["D" /* ToolbarButton */], {
        label: this.props.maximized ? 'Minimize' : 'Maximize',
        icon: "maximize",
        isActive: this.props.studies.length > 0,
        onClick: this.props.handleMaximize
      }), this.props.studies.length > 0 && react_default.a.createElement(src["D" /* ToolbarButton */], {
        label: "Upload image",
      ...
      }, this.buttonGroups.right.length && react_default.a.createElement(src["r" /* RoundedButtonGroup */], {
...
_defineProperty(ToolbarRow_ToolbarRow, "propTypes", {
  ...
  showMaxMin: prop_types_default.a.bool.isRequired
});
...
function _getExpandableButtonComponent(button, activeButtons) {
  ...
  return react_default.a.createElement(src["g" /* ExpandableToolMenu */], {
    key: button.id,
    label: button.label,
    icon: button.icon,
...
function _getDefaultButtonComponent(button, activeButtons) {
  return react_default.a.createElement(src["D" /* ToolbarButton */], {
    key: button.id,
    label: button.label,
    icon: button.icon,
...
/* harmony default export */ var connectedComponents_ToolbarRow_0 = (Object(dist_es["d" /* withTranslation */])(['Common', 'ViewportDownloadForm'])(Object(src["N" /* withModal */])(Object(src["M" /* withDialog */])(Object(AppContext["e" /* withAppContext */])(ToolbarRow_ToolbarRow)))));
...
var makeLayout = __webpack_require__(1029);
...
var studyMetadataManager = core_src["a" /* OHIF */].utils.studyMetadataManager;
var ConnectedStudyBrowser_OHIF$redux$actions = core_src["a" /* OHIF */].redux.actions,
...
var ConnectedStudyBrowser_mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    onThumbnailClick: function onThumbnailClick(displaySetInstanceUID, seriesInstanceUID) {
      ...
      var stuff = Object(makeLayout["a" /* default */])(ownProps.studyMetadata, seriesInstanceUID); //dispatch(setViewportLayoutAndData(stuff.layout, stuff.data));
...
var ConnectedStudyBrowser = Object(es["b" /* connect */])(ConnectedStudyBrowser_mapStateToProps, ConnectedStudyBrowser_mapDispatchToProps)(src["x" /* StudyBrowser */]);
...
var connectedComponents_ViewerMain = __webpack_require__(1059);

// EXTERNAL MODULE: ./components/DentalGrid/ViewportGrid.css
var DentalGrid_ViewportGrid = __webpack_require__(1060);
...
var DentalGrid_ViewportPane = __webpack_require__(1061);
...
var EmptyViewport = __webpack_require__(1062);
...
var ViewportGrid_ViewportGrid = function ViewportGrid(props) {
  var activeViewportIndex = props.activeViewportIndex,
      activeSeriesUID = props.activeSeriesUID,
...
var memoize = __webpack_require__(638);
...
var ConnectedViewportGrid_setViewportActive = core_src["b" /* default */].redux.actions.setViewportActive;
...
var ConnectedViewportGrid_mapStateToProps = function mapStateToProps(state) {
  ...
  var _state$viewports = state.viewports,
      ...
      activeViewportIndex = _state$viewports.activeViewportIndex,
      activeSeries = _state$viewports.activeSeries;
  return {
    layout: layout,
...
var values = __webpack_require__(1063);
  ...
  function ViewerMain(props) {
    ...
    ViewerMain_defineProperty(ViewerMain_assertThisInitialized(_this), "setViewportData", function (_ref) {
      ...
      if (displaySet && displaySet.isDerived) {
        ...
        if (Modality === 'SEG' && App["d" /* servicesManager */]) {
          var _servicesManager$serv = App["d" /* servicesManager */].services,
...
var ConnectedViewerMain_OHIF$redux$actions = core_src["b" /* default */].redux.actions,
...
var components_SidePanel = __webpack_require__(1065);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog = __webpack_require__(1066);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog_ErrorBoundaryDialog = function ErrorBoundaryDialog(_ref) {
  ...
  var handleOnError = function handleOnError(error, componentStack) {
    var ErrorDialog = function ErrorDialog() {
      ...
      }, react_default.a.createElement(src["h" /* Icon */], {
        name: "chevron-down",
  ...
  return react_default.a.createElement(src["e" /* ErrorBoundary */], {
...
var SimpleDialog = __webpack_require__(496);

// EXTERNAL MODULE: ./components/LayoutPickerDialog/LayoutPickerDialog.css
var LayoutPickerDialog_LayoutPickerDialog = __webpack_require__(1067);
  ...
  */
  ...
  LayoutPickerDialog_createClass(LayoutPickerDialog, [{
    ...
    value: function render() {
      ...
      }, react_default.a.createElement(src["z" /* TableList */], {
        headless: true
      }, this.state.layouts.map(function (name, index) {
        return react_default.a.createElement(src["A" /* TableListItem */], {
...
// EXTERNAL MODULE: /home/david/dev/evs/viewer/ohif/platform/core/src/enums.js
...
var cornerstoneWADOImageLoader_min = __webpack_require__(58);
...
function (_Component) {
  ...
  function Viewer(props) {
    ...
    Viewer_defineProperty(Viewer_assertThisInitialized(_this), "retrieveTimepoints", function (filter) {
      core_src["b" /* default */].log.info('retrieveTimepoints'); // Get the earliest and latest study date
    ...
    core_src["b" /* default */].measurements.MeasurementApi.setConfiguration({
      dataExchange: {
    ...
    core_src["b" /* default */].measurements.TimepointApi.setConfiguration({
      dataExchange: {
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function componentDidMount() {
      ...
      var _OHIF$measurements = core_src["b" /* default */].measurements,
    ...
    value: function createNewStudy(layout) {
      ...
      if (layout === 'Panoramic') {
        ...
        imageBoxes = [{
          ...
          "00720108": {
            vr: "FD",
            Value: [0.25 + m / 2, 1 - h, 0.5 - m / 2, 0 + h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [0.5 + m / 2, 1 - h, 0.75 - m / 2, 0 + h]
          }
        }, {
          "00720302": {
            vr: "US",
        ...
        imageBoxes = [// left six boxes
        {
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm, w * 2 - m / 2, 1 + hm / 2 - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [0 + m, 1 - hm / 2 - h, w - m / 2, 1 + hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm / 2 - h, w * 2 - m / 2, 1 + hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [0 + m, 1 - hm / 2 - h * 2, w - m / 2, 1 + hm / 2 - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w + m / 2, 1 - hm / 2 - h * 2, w * 2 - m / 2, 1 + hm / 2 - h * 3]
          }
        }, // middle top boxes
        {
          "00720302": {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 2 + m / 2, 1 - hm, w * 3 - m / 2, 1 + hm / 2 - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 3 + m / 2, 1 - hm, w * 4 - m / 2, 1 + hm / 2 - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 4 + m / 2, 1 - hm, w * 5 - m / 2, 1 + hm / 2 - h]
          }
        }, // middle bottom boxes
        {
          "00720302": {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 2 + m / 2, 1 - hm / 2 - h * 2, w * 3 - m / 2, 1 + hm / 2 - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 3 + m / 2, 1 - hm / 2 - h * 2, w * 4 - m / 2, 1 + hm / 2 - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 4 + m / 2, 1 - hm / 2 - h * 2, w * 5 - m / 2, 1 + hm / 2 - h * 3]
          }
        }, // right six boxes
        {
          "00720302": {
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m / 2, 1 - hm, w * 6 - m / 2, 1 + hm / 2 - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm, w * 7 - m, 1 + hm / 2 - h]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m / 2, 1 - hm / 2 - h, w * 6 - m / 2, 1 + hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm / 2 - h, w * 7 - m, 1 + hm / 2 - h * 2]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 5 + m / 2, 1 - hm / 2 - h * 2, w * 6 - m / 2, 1 + hm / 2 - h * 3]
          }
        }, {
          "00720302": {
            vr: "US",
          ...
          "00720108": {
            vr: "FD",
            Value: [w * 6 + m / 2, 1 - hm / 2 - h * 2, w * 7 - m, 1 + hm / 2 - h * 3]
          }
        }];
      }
    ...
    value: function render() {
      ...
      return react_default.a.createElement(react_default.a.Fragment, null, this.state.isSelectingLayout && react_default.a.createElement(components_LayoutPickerDialog, {
        ...
        studies: this.props.studies,
        maximized: this.props.maximized,
        showMaxMin: maxDisplaySet && this.props.viewports[this.props.activeViewportIndex].numImageFrames > 0
      })), react_default.a.createElement("div", {
...
/* harmony default export */ var connectedComponents_Viewer_0 = (Object(src["M" /* withDialog */])(Viewer_Viewer));
/**
...
var ConnectedViewer_OHIF$redux$actions = core_src["b" /* default */].redux.actions,
...
var ConnectedViewer_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    onNewStudy: function onNewStudy(structuredDisplay, viewports) {
      // NOTE: order of dispatch matters
      dispatch(ConnectedViewer_setActiveSeries(structuredDisplay.SeriesInstanceUID, viewports, {}));
      dispatch(setStudyData(structuredDisplay.StudyInstanceUID, structuredDisplay)); //dispatch(setLayout(layout)); let it be updated after retrieve study data is done
    }
  };
};
