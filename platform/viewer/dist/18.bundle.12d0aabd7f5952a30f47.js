...
function (_Component) {
  ...
  function OHIFCornerstoneViewport() {
    ...
    function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(studies, StudyInstanceUID, displaySet, displaySetInstanceUID, SOPInstanceUID, frameIndex) {
        var viewportData, stack;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                stack = OHIFCornerstoneViewport.getCornerstoneStack(studies, StudyInstanceUID, displaySet, displaySetInstanceUID, SOPInstanceUID, frameIndex);
                viewportData = {
  ...
  _createClass(OHIFCornerstoneViewport, [{
    ...
    value: function setStateFromProps() {
      ...
      this.getViewportData(studies, StudyInstanceUID, displaySet, displaySetInstanceUID, SOPInstanceUID, frameIndex).then(function (viewportData) {
        _this2.setState({
    ...
    value: function getCornerstoneStack(studies, StudyInstanceUID, displaySet, displaySetInstanceUID, SOPInstanceUID) {
      var frameIndex = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
