  ...
  createNewStudy(layout) {
    ...
    if (layout === 'Panoramic') {
      ...
      imageBoxes = [
        ...
        {
          "00720302": {vr: "US", Value: [2]},
          "00720108": {vr: "FD", Value: [0+m, 1-hm-h, w-m/2, 1-hm/2-h*2]}
        },
        {
          "00720302": {vr: "US", Value: [3]},
          "00720108": {vr: "FD", Value: [w+m/2, 1-hm-h, w*2-m/2, 1-hm/2-h*2]}
        },
        {
        ...
        },
        {
          ...
          "00720108": {vr: "FD", Value: [w*5+m, 1-hm-h, w*6-m/2, 1-hm/2-h*2]}
        },
        {
          "00720302": {vr: "US", Value: [15]},
          "00720108": {vr: "FD", Value: [w*6+m/2, 1-hm-h, w*7-m/2, 1-hm/2-h*2]}
        },
        {
