    ...
    if (layout === 'Panoramic') {
      ...
      imageBoxes = [
        ...
        },
        {
          ...
          "00720108": {vr: "FD", Value: [0+m, 1-hm/2-h*2, w-m/2, 1-hm-h*3]}
        },
        {
          "00720302": {vr: "US", Value: [5]},
          "00720108": {vr: "FD", Value: [w+m/2, 1-hm/2-h*2, w*2-m/2, 1-hm-h*3]}
        },
        // middle top boxes
        {
          "00720302": {vr: "US", Value: [6]},
          "00720108": {vr: "FD", Value: [w*2+m, 1-hm, w*3-m/2, 1-hm/2-h]}
        },
        {
        ...
        // middle bottom boxes
        {
          ...
          "00720108": {vr: "FD", Value: [w*2+m, 1-hm/2-h*2, w*3-m/2, 1-hm-h*3]}
        },
        {
          "00720302": {vr: "US", Value: [10]},
          "00720108": {vr: "FD", Value: [w*3+m/2, 1-hm/2-h*2, w*4-m/2, 1-hm-h*3]}
        },
        {
          "00720302": {vr: "US", Value: [11]},
          "00720108": {vr: "FD", Value: [w*4+m/2, 1-hm/2-h*2, w*5-m/2, 1-hm-h*3]}
        },
        // right six boxes
        {
